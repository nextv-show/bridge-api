...
import com.sanshuiyuan.iot.auth.H5JwtFilter;
import com.sanshuiyuan.iot.auth.H5JwtService;
import com.sanshuiyuan.iot.auth.S2sTokenFilter;
...
/**
 * 鉴权：C 端路径 /api/iot/** 用 H5 JWT；/internal/** 用 S2S shared token；
 * actuator/api-docs 放行。设备认证走 MQTT，不走 HTTP。
 */
@Configuration
@EnableWebSecurity
