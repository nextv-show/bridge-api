...
public class ReconcilePendingOrdersJob {
    ...
    public ReconcilePendingOrdersJob(CendOrderRepository orderRepo, WxPayClient wxPayClient,
    ...
    public void reconcile() {
        ...
        List<CendOrder> pending = orderRepo.findByStatus(OrderStatus.PENDING_PAY);
        for (CendOrder order : pending) {
            try {
