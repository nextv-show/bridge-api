package com.sanshuiyuan.cend.rebate.api;

import com.sanshuiyuan.cend.auth.CurrentOpenid;
import com.sanshuiyuan.cend.common.ApiResponse;
import com.sanshuiyuan.cend.rebate.api.dto.PendingRebateItem;
...
public class RebateController {
    ...
    public RebateController(RebateService rebateService, CendUserRepository userRepo) {
    ...
    private Optional<Long> currentBeneficiaryId() {
        ...
        return userRepo.findByOpenid(openid).map(CendUser::getId);
    }
}
