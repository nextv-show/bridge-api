...
public class ReferralBindingService {
    ...
    public ReferralBindingService(CendUserRepository userRepo, RefIdCodec refIdCodec) {
     ...
     */
    @Transactional
    public CendUser onWxLogin(String openid, String nickname, String avatarUrl) {
        CendUser user = userRepo.findByOpenid(openid)
                .orElseGet(() -> userRepo.save(CendUser.create(openid)));
