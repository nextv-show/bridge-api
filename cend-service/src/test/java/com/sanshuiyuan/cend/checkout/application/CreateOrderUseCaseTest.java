...
class CreateOrderUseCaseTest {
    ...
    void execute_success_createsOrder() {
        ...
        ArgumentCaptor<CendOrder> captor = ArgumentCaptor.forClass(CendOrder.class);
        verify(orderRepo).save(captor.capture());
        CendOrder saved = captor.getValue();
    ...
    void execute_snapshotsReferralChainOntoOrder() {
        ...
        CendUser bound = CendUser.create("openid1");
    ...
    void execute_pendingOrderWithin30Min_reusesExistingOrder() {
        ...
        CendOrder existingOrder = CendOrder.create("H5EXISTING123", "openid1", "home-pro", "BR-H2", 680000L, "WX_JSAPI");
