...
class InvoiceServiceTest {
    ...
    private CendOrder buildOrder(Long id, String openid) {
        CendOrder order = CendOrder.create("ORD" + id, openid, "spec-1", "MODEL-X",
                680000L, "WX_JSAPI");
    ...
    void getInvoice_alreadyIssued_returnsIssuedWithUrl() {
        CendOrder order = buildOrder(1L, "user-A");
    ...
    void getInvoice_notYetIssued_returnsIssuing() {
        CendOrder order = buildOrder(2L, "user-B");
    ...
    void getInvoice_noRecordYet_autoCreatesAndReturnsIssuing() {
        CendOrder order = buildOrder(3L, "user-C");
    ...
    void getInvoice_notOwner_throws403() {
        CendOrder order = buildOrder(4L, "user-D");
