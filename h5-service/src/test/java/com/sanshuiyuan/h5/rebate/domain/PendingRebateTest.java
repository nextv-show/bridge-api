...
/**
 * T11.9 返利状态机全路径 + 单向流转守卫。
 */
class PendingRebateTest {

    @Test
    void freeze_initialState_isFrozenWithTimestamp() {
        PendingRebate r = PendingRebate.freeze(1L, 10L, RebateLevel.L1, 100L);
    ...
    void freeze_nullAmount_defaultsToZero() {
        PendingRebate r = PendingRebate.freeze(1L, 10L, RebateLevel.L2, null);
