...
class AssetQueryServiceTest {
    ...
    private AssetQueryService createService() {
        return new AssetQueryService(orderRepo, specRepo, invoiceRepo);
    }

    // ─── helpers ───

    private H5Order buildOrder(Long id, String openid, String specId, String modelCode,
                               long amountCents, OrderStatus status, String sn,
                               LocalDateTime cooldownEndAt) {
        H5Order order = H5Order.create("ORD" + id, openid, specId, modelCode,
    ...
    void queryAsset_ownerQuery_returnsFullAsset() {
        ...
        H5Order order = buildOrder(1L, "user-A", "home-pro", "BR-H2",
    ...
    void queryAsset_notOwner_throws403() {
        H5Order order = buildOrder(2L, "user-B", "spec-1", "M1",
    ...
    void queryAsset_refundedOrder_stillQueryable() {
        H5Order order = buildOrder(3L, "user-C", "spec-2", "M2",
    ...
    void queryAsset_cooldownEndAt_usesColumnValue() {
        ...
        H5Order order = buildOrder(4L, "user-D", "spec-3", "M3",
    ...
    void queryAsset_noCooldownEndAt_remainingSecondsZero() {
        H5Order order = buildOrder(5L, "user-E", "spec-4", "M4",
    ...
    void queryAsset_specNotFound_fallsBackToModelCode() {
        H5Order order = buildOrder(6L, "user-F", "spec-missing", "FALLBACK-MODEL",
    ...
    void queryAsset_noInvoice_returnsIssuing() {
        H5Order order = buildOrder(7L, "user-G", "spec-5", "M5",
