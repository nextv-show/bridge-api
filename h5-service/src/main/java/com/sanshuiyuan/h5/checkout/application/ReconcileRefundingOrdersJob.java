...
public class ReconcileRefundingOrdersJob {
    ...
    public ReconcileRefundingOrdersJob(H5OrderRepository orderRepo, RefundRepository refundRepo,
    ...
    public void reconcile() {
        ...
        List<H5Order> refunding = orderRepo.findByStatus(OrderStatus.REFUNDING);
        for (H5Order order : refunding) {
            try {
