...
-- 背景：canonical users 表归未部署的 user-service（user_db，见 008a T8a.1）；h5-service 以 openid 自有认证。
-- 为使 H5 推广关系链在「仅部署 h5-service」的真实生产环境可落地，h5-service 在 h5_db 维护自有轻量身份表。
